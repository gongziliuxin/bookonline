        ...
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">H-ui.admin</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a>
            ...
            <nav class="nav navbar-nav">
                <ul>
                    ...
                    <li class="navbar-levelone"><a href="/bookcityinto">商城</a></li>
            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    ...
                    <li class="dropDown dropDown_hover">
                        <a href="#" class="dropDown_A" id="adminName"> <i class="Hui-iconfont">&#xe6d5;</i></a>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a data-href="article-list.html" data-title="订单管理" href="javascript:void(0)">订单信息管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-picture">
            ...
            <dd>
                <ul>
                    <li><a data-href="/booklists" data-title="书籍管理" href="/booklists">书籍信息管理</a></li>
                </ul>
            </dd>
        </dl>
        ...
        <dl id="menu-member">
            ...
            <dd>
                <ul>
                    <li><a data-href="/custom" data-title="会员列表" href="${pageContext.request.contextPath}/custom">会员列表</a></li>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${pageContext.request.contextPath}/lib/jquery.contextmenu/jquery.contextmenu.r2.js">

</script>
<script type="text/javascript">
    var value = ((decodeURI(window.location.pathname)).split("/"))[2];
    $("#adminName").append(value);
