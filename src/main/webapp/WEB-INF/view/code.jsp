...
cimg.src = "https://ynuf.alipay.com/service/clear.png?xt=Pb45a76bf8862512bc220e3c66ad8b83f&xa=";
</script>
...
um.init({
    ...
    token: 'Pb45a76bf8862512bc220e3c66ad8b83f', timestamp: '0514129851595844504B6C75',
    ...
    <span data-role="J_questionIcon" seed="order-type-detail" style="cursor: pointer;color: #08c;">[?]</span>
            ...
            <span class="first long-content">
                环保阅读-22bat.com-订单号：2018092051499736997
            </span>
                    ...
                    <span class="payAmount-area" id="J_basePriceArea">
                                                     <strong class=" amount-font-22 ">18.16</strong> 元
                ...
                <div class="ui-detail fn-hide" data-role="J_orderDetailCnt" id="J-orderDetail">
                    <div class="ajax-Account od-more-cnt fn-clear">
                        <div class="first  long-content">环保阅读-22bat.com-订单号：2018092051499736997</div>
            ...
            <input name="oid" type="hidden" value="6c432f85bcc34a429cde9ef9a62c1beb.20" id="J_orderId" />
            <input name="pid" type="hidden" value="2088021640627624" id="J_partnerId" />
            <input name="pid" type="hidden" value="36997" id="J_outBizID" />
            <input name="qrContextId" type="hidden" value="201809200030574820a08baac8268b1101" id="J_qrContextId" />
            ...
            <div data-module="excashier/login/2016.08.01/loginPwdMemberT" id="J_loginPwdMemberTModule" class="cashiser-switch-wrapper fn-clear" >
                ...
                <div class="cashier-center-view view-qrcode fn-left" id="J_view_qr">
                    ...
                    <div id="hidden-input-area" class="fn-hide">
                        <input name="qrCode"            type="hidden" value="https://qr.alipay.com/upx01002vms1s6wxdq092091"          id="J_qrCode" />
                        <input name="qrImgUrl"          type="hidden" value="https://mobilecodec.alipay.com/show.htm?code=upx01002vms1s6wxdq092091"        id="J_qrImgUrl" />
                        <input name="qrUseImage" 		type="hidden" value="false" 		id="J_qrUseImage"/>
                        <input name="qrContextId"       type="hidden" value="201809200030574820a08baac8268b1101"     id="J_qrContextId" />
                        <input name="qrRenewalURL"      type="hidden" value="https://excashier.alipay.com:443/standard/renewQRCode.json?payOrderId=6c432f85bcc34a429cde9ef9a62c1beb.20"    id="J_qrRenewalURL" />
                        <input name="qrPushCheckURL"    type="hidden" value=""  id="J_qrPushCheckURL" />
                        <input name="qrLoopCheckURL"    type="hidden" value="https://excashier.alipay.com:443/standard/queryQRStatus.json?payOrderId=6c432f85bcc34a429cde9ef9a62c1beb.20"  id="J_qrLoopCheckURL" />
                        <input name="qrPaySuccGotoURL"  type="hidden" value="https://unitradeprod.alipay.com:443/acq/cashierReturn.htm?sign=K1iSL1mnWM6ee%252F1vDes0321ypXiCK3BalMW1OiWaIMWbk9oBfFiG&amp;outTradeNo=36997&amp;pid=2088021640627624&amp;type=1" id="J_qrPaySuccGotoURL" />
                    ...
                    <div data-role="qrPayArea" class="qrcode-integration qrcode-area" id="J_qrPayArea">
                        <div class="qrcode-header">
                            ...
                            <div class="ft-center qrcode-header-money">18.16</div>
                        </div>
                ...
                <div class="cashier-center-view view-pc fn-left" id="J_view_pc">
                    <form action="https://excashier.alipay.com:443/standard/securityPost.json?payOrderId=6c432f85bcc34a429cde9ef9a62c1beb.20&viewModel=payerPwdLoginViewModel" method="post" id="J_TloginForm">
                        <input type="hidden" name="commonAccountIdentiAuthUrl" value="https://excashier.alipay.com:443/standard/securityRender.phtm?payOrderId=6c432f85bcc34a429cde9ef9a62c1beb.20&viewModel=payerPwdLoginViewModel"/>
                        <input type="hidden" name="_form_token" value="daa0260c777e59e64567a529701dce959c4584d83ad14703ab85c98f093965e3RZ11"/>
	...
	<input type="hidden" name="pwdSecurityId" value="web|excashier_payment_pwd_control|19523a63-d0ed-4793-b294-567f055feaf9RZ11" />
  ...
  (function () {
      ...
      s.sid = "web|excashier_payment_pwd_control|19523a63-d0ed-4793-b294-567f055feaf9RZ11";
  })();
</script>
...
<input type="hidden" id="alieditUid" name="alieditUid" value="7b85d0a7b2922e89b98dfacb909258c2" />
...
<script>
  light.node('#payPasswd').parent().find('[name=security_activeX_enabled]')[0].value = alipay.security.activeXEnabled;
      ...
      alipay.security.snowden.record('web|excashier_payment_pwd_control|19523a63-d0ed-4793-b294-567f055feaf9RZ11', {products:'singlePassword'});
    </script>
  ...
  (function(){
      ...
      var renderArr = 'R',
          ...
          options = {
              ...
              id: 'payPasswd',
              prodType: '',
              sid: 'web|excashier_payment_pwd_control|19523a63-d0ed-4793-b294-567f055feaf9RZ11'
          },
          renderOptions = {
              downloadPath: '',
              ...
              R: {
                  ...
                  tabindex: "",
                  container: "payPasswd_container",
                  ksk: 'b84da8b0-ba4f-474e-83d4-913cb52a3da0',             useSixDigitPassword: false           },
              C1: {
                  id: "edit_payPasswd",
                  name: "edit_payPasswd",
                  hidnId: "payPasswd",
              ...
              C2: {
                  ...
                  useKS: true,
                  ksk: 'b84da8b0-ba4f-474e-83d4-913cb52a3da0'           }
          },
          sensorOptions = {
    ...
    <script type="text/javascript">
        var form_tk = "x8PgHqTyEzZVBWDAcofJYh6zkTMLFb8Q";
        var json_ua = null;
    </script>

    <script type="text/javascript" charset="utf-8" src='https://rds.alipay.com/ua_excashier_rds_auth.js?t=20180919'></script>

    <!-- FD:231:alipay/security/sensorSdk.vm:START --><script src="https://a.alipayobjects.com/sensor-sdk/2.0.0/index.js"></script>
    ...
    <div   class="fn-hide" data-role="fishing-popup">
        ...
        <div class="anti-fishing">
            ...
            <p>您购买的商品为：<span class="ft-break ft-bold ft-red">环保阅读-22bat.com-订单号：2018092051499736997</span>，收款方为：<strong><font color="red">上海虞衡文化传播有限公司</font></strong>，请确认。</p>
    ...
    <input type="hidden" name="commonAgreementUrl" value="https://excashier.alipay.com:443/standard/agreementDetail.phtm?payOrderId=6c432f85bcc34a429cde9ef9a62c1beb.20&viewModel=standard%3AcommonAgreementViewModel.vm" />
    <input type="hidden" name="memoryPayAgreementUrl" value="https://excashier.alipay.com:443/standard/agreementDetail.phtm?payOrderId=6c432f85bcc34a429cde9ef9a62c1beb.20&viewModel=standard%3AmemoryPayAgreementViewModel.vm" />
    ...
    <div id="footer">
        ...
        <div class="server" id="ServerNum">
            excashier-30-5255 &nbsp; 0be92a2a15374138761112075eb85e_0_1
        </div>
    ...
    try {
        (function() {
            ...
            if (!!window.addEventListener && Array.prototype.map && Math.random() < sample) {
                ...
                setTimeout(function() {
                    window.httpWatch && window.httpWatch({ sample: 1, appname: 'excashier-30-5255', logServer: logServer });
                }, 1000);
            }
        })();
    } catch(e) {}
